# 🧠 YOLO 시리즈 완전 가이드: YOLOv8 vs YOLOv11 기술 분석 및 비교

> 본 문서는 객체 탐지(Object Detection)의 대표 알고리즘인 **YOLO(You Only Look Once)**의 전반적인 이해와 함께, 최신 버전인 **YOLOv8**과 **YOLOv11**의 기술적 차이점을 심층 분석합니다.
...
2. [YOLO의 역사와 진화](#yolo의-역사와-진화)
3. [YOLO 핵심 구조](#yolo-핵심-구조)
4. [YOLOv8 상세 분석](#yolov8-상세-분석)
5. [YOLOv11 상세 분석](#yolov11-상세-분석)
6. [YOLOv8 vs YOLOv11 기술 비교](#yolov8-vs-yolov11-기술-비교)
7. [YOLO 활용 분야](#yolo-활용-분야)
8. [코드 예시 및 실습](#코드-예시-및-실습)
9. [추가 참고 자료](#추가-참고-자료)
